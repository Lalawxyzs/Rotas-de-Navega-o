...
import 'package:lais_aula_08/screens/login_screen.dart';
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> serviceOrders = [
      ...
      },
      {
        ...
        'status': 'Concluída',
        'desc': 'Troc de switch e teste de patch panel.',
      },
    ];
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: Icon(
                        os['status'] == 'Concluída'
                          ? Icons.check_circle : os['status'] == 'Em Andamento'
                          ? Icons.pending      : Icons.error_outline,
                        color: os['status'] == 'Concluída'
                          ? Colors.green : os['status'] == 'Em Andamento'
